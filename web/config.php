...
if (!version_compare(phpversion(), '5.3.3', '>=')) {
    $version = phpversion();
    $majorProblems[] = <<<EOF
        You are running PHP version "<strong>$version</strong>", but Silexplate
        needs at least PHP "<strong>5.3.3</strong>" to run. Before using Silexplate, install
...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>Silexplate Configuration</title>
    </head>
    <body>
                ...
                <div class="silex-block-content">
                    ...
                    <?php if (count($minorProblems)): ?>
                        ...
                        <p>
                            ...
                            <?php else: ?>
                                To<?php endif; ?>
                            enhance your Silexplate experience, it’s recommended that you fix the following :
                        </p>
                        <ol>
